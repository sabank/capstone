...
saveRDS(unigrams2, file = "./data/unigrams_final.rds")
rm("unigrams", "unigrams2")

saveRDS(bigrams2, file = "./data/bigrams_final.rds")
rm("bigrams", "bigrams2")

saveRDS(trigrams2, file = "./data/trigrams_final.rds")
rm("trigrams", "trigrams2")

saveRDS(fourgrams2, file = "./data/fourgrams_final.rds")
rm("fourgrams", "fourgrams2")

saveRDS(fivegrams2, file = "./data/fivegrams_final.rds")
rm("fivegrams", "fivegrams2")

saveRDS(codes2, file = "./data/codes_final.rds")
rm("codes2")
